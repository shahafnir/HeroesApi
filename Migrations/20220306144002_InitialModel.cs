        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartedTrainingAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Heroes_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HeroSuitColors", x => new { x.HeroId, x.ColorName });
                    table.ForeignKey(
                        name: "FK_HeroSuitColors_Heroes_HeroId",
                        column: x => x.HeroId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HeroTrainings", x => new { x.HeroId, x.TrainedAt });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Heroes_ApplicationUserId",
                table: "Heroes",
